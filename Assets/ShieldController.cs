...
public class ShieldController : MonoBehaviour {
    ...
    void Start () {
        ...
        ShieldAlert = audioSources[0];
        ShieldEnd = audioSources[1];
    }
    ...
    void Update ()
    {
        ...
        if (Param.ShieldTime <= 3.02f && Param.ShieldTime >= 2.98f)
        {
        ...
        else if (Param.ShieldTime <= 0.02f && Param.ShieldTime >0)
        {
            ShieldEnd.PlayOneShot(ShieldEnd.clip);
        }
    }
}
